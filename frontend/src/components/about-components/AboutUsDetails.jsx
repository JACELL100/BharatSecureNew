...
const AboutUsDetails = () => {
  return (
    <div className="p-12 bg-[#0f0f0f] min-h-screen">
      <div className="p-8 bg-[#1a1a1a] rounded-xl">
        <h1 className="text-4xl font-bold mb-8 text-[#4da6a8] font-['Smooch_Sans']">
          About BharatSecure
        </h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <div className="space-y-8">
            <div className="p-6 bg-[#2a2a2a] rounded-xl">
              <h2 className="text-2xl font-bold mb-4 text-[#4da6a8] font-['Smooch_Sans']">
                Our Mission
              </h2>
              <p>
